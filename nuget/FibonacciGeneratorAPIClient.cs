...
namespace APIVerve.API.FibonacciGenerator
{
    ...
    /// <summary>
    /// Client for the FibonacciGenerator API
    /// </summary>
    public class FibonacciGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/fibonaccigenerator";
        ...
        {
            { "count", new ValidationRule { Type = "integer", Required = true, Min = 1, Max = 1000 } },
            { "startfrom", new ValidationRule { Type = "integer", Required = false, Min = 0 } }
        };
        ...
        public FibonacciGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FibonacciGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FibonacciGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, FibonacciGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(FibonacciGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(FibonacciGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(FibonacciGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(FibonacciGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(FibonacciGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(FibonacciGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(FibonacciGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(FibonacciGeneratorQueryOptions options)
        {
