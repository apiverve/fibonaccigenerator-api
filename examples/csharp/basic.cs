...
{
    class FibonacciGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/fibonaccigenerator";

        /// <summary>
        /// Make a GET request to the Fibonacci Generator API
        /// </summary>
        static async Task<JsonDocument> CallFibonacciGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;count&quot;] &#x3D; 10, [&quot;startfrom&quot;] &#x3D; 0 };
        ...
        {
            Console.WriteLine("📤 Calling Fibonacci Generator API...\n");

            var result = await CallFibonacciGeneratorAPI();
