...
namespace APIVerve\Fibonaccigenerator;
...
/**
 * Client for the Fibonacci Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/fibonaccigenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/fibonaccigenerator';
    ...
    private const VALIDATION_RULES = [
        ...
        'startfrom' => ['type' => 'integer', 'required' => false, 'min' => 0]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\FibonaccigeneratorClient] {$message}\n";
        }
    }
}
