...
class fibonaccigeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/fibonaccigenerator');
        }
        ...
        this.validationRules = {"count":{"type":"integer","required":true,"min":1,"max":1000},"startfrom":{"type":"integer","required":false,"min":0,"default":0}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/fibonaccigenerator`);
        }
    }
...
module.exports = fibonaccigeneratorWrapper;
