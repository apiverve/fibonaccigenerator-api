# Fibonacci Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:fibonaccigenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.fibonaccigenerator.FibonacciGeneratorAPIClient;
import com.apiverve.fibonaccigenerator.APIResponse;
import com.apiverve.fibonaccigenerator.APIException;

// Initialize the client
FibonacciGeneratorAPIClient client = new FibonacciGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/fibonaccigenerator](https://docs.apiverve.com/ref/fibonaccigenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/fibonaccigenerator](https://docs.apiverve.com/ref/fibonaccigenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/fibonaccigenerator-api/issues)
