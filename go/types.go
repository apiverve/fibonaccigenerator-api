// Package fibonaccigenerator provides a Go client for the Fibonacci Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/fibonaccigenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Fibonacci Generator API.
//
// Parameters:
//   - count (required): integer - Number of Fibonacci numbers to generate [min: 1, max: 1000]
//   - startfrom: integer - Start from this position in the sequence [min: 0]
type Request struct {
	Count int `json:"count"` // Required
	Startfrom int `json:"startfrom,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"count": {Type: "integer", Required: true, Min: float64Ptr(1), Max: float64Ptr(1000)},
		"startfrom": {Type: "integer", Required: false, Min: float64Ptr(0)},
	}
...
// ResponseData contains the data returned by the Fibonacci Generator API.
type ResponseData struct {
	...
	GoldenRatioApproximation float64 `json:"golden_ratio_approximation"`
}
